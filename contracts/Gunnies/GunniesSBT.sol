...
//     event Kill(uint256 matchId, address from, address to);
//     event KillTotal(uint256 matchId, address from, address to, uint256 totalKill);
...
//     function Kill(uint256 _matchId, address _from, address _to) external {
//          emit Kill(_matchId,  msg.sender ,_to);
//     emit KillTotal(_matchId, address from, address to, uint256 totalKill);
