...
contract Kaboom_Distributor is BasicAccessControl {
    ...
    constructor(address _kaboom, IERC20 _erc20Token) {
        blockchainSuperheroes = _kaboom;
        erc20Token = IERC20(_erc20Token);
    }

    uint256 public mintingCount = 0;
    uint256 public mintingCap = 1_000_000_000;
    ...
    function setContracts(address _kaboom) external onlyOwner {
        blockchainSuperheroes = _kaboom;
    }
