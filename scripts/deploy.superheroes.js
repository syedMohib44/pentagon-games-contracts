...
async function main() {
  ...
  const BCSH_Distributor = await ethers.getContractFactory("SetsukoDistributor");
  this.BCSH_Distributor = await BCSH_Distributor.connect(addr1).deploy("0xcDAD57bFc48E8373280C6dc3039C5169353B6879");
  ...
  await hre.run("verify:verify", {
    ...
    constructorArguments: ["0xcDAD57bFc48E8373280C6dc3039C5169353B6879"],
